...
1. An example "native" [ERC721]([/contracts/src/Mocks/ExampleERC721.sol)](https://github.com/ava-labs/avalanche-starter-kit/blob/main/contracts/misc/erc721-bridge/BridgeNFT.sol) token is deployed on subnet A
